...
2. The ort-strategy - слияние при изменениях в мастере и вторичной ветке в разных частях документов. При этом появляется автоматический коммит "Branch merging". Последнее изменение должно быть в мастере.
